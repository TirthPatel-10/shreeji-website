  ...
  return (
    <main className="bg-black text-white">
      ...
      <section className="h-screen flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
        ...
        <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white to-gray-400 text-transparent bg-clip-text">
          Industrial Meets Creative
        </h1>

        <p className="text-gray-400 max-w-xl mb-8">
          High-end signage solutions designed to elevate your brand identity.
        </p>
      ...
      <section className="py-24 bg-black text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Card 1 */}
            <div className="p-6 rounded-xl bg-white/5 backdrop-blur-lg border border-white/10 hover:scale-105 transition duration-300">
